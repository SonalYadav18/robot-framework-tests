...
Login Page Validation
    sauceapp.Verify Login Page

Successful Login
    sauceapp.Enter the correct credentials and Login

Products Page Validation
    sauceapp.Verify Products Page    

Products addition to cart    
    sauceapp.Add Products to cart
...
#     Should Contain    ${loginpass}    Products
    ...
    # ${queryvar}=    Execute Javascript    return document.querySelector('aside').shadowRoot.querySelector('#accept')
    # Click button     ${queryvar}